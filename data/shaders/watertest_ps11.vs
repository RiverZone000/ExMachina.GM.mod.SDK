...
//
// $Id: waterTest_ps11.vs,v 1.4 2005/10/05 08:18:14 goryh Exp $
//
//////////////////////////////////////////////////////////////////////////////
 ...
 */
float4 waterTilesInfo[70]: register( c20 );
...
VS_OUTPUT WaterVS( VS_INPUT v )
{
	...
	float2 TexShiftRipple = float2( timeVal * 0.5f, timeVal );
	float2 NoiseCoords;
	NoiseCoords = v.PackedPosInfo.xy * numVertsInWaterTileEdgeRec;
